...
namespace Serializator
{
    public class DatabaseHandler : IDatabaseHandler
    {
        ...
        {
            if (database == null) { await Init(); }
            UnityEngine.Debug.Log("HandlerSave method:" + "UserId: " + userId + " SaveId " + saveId + " playerPosition " + gameData.playerPosition.ToString());
        ...
        {
            if (database == null) { await Init(); }
            UnityEngine.Debug.Log("Create New Game method");
            ...
            UnityEngine.Debug.Log($"NewId {newId}");
            return newId;
        }
        public async Task<GameData> Load(int saveId)
        {
            UnityEngine.Debug.Log("HandlerLoad method saveId: " + saveId);
